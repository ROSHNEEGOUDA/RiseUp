                    ...
                    <div className="container mx-auto max-w-4xl">
                        <div className="bg-gradient-to-br from-blue-900/40 to-purple-900/40 backdrop-blur-md rounded-3xl p-10 text-center shadow-2xl border border-white/10">
                            ...
                            <p className="text-lg mb-8 max-w-xl mx-auto">
                                Join RiseUp today and connect with NGOs offering quality training programs and employers seeking fresh talent.
                            </p>
                ...
                <footer className="py-12 px-4 border-t border-white/10">
                    <div className="container mx-auto">
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                            <div>
                                <h3 className="text-xl font-bold mb-4">RiseUp</h3>
                            ...
                            <div>
                                ...
                                <ul className="space-y-2">
                                    <li className="text-white/70">info@RiseUp.org</li>
